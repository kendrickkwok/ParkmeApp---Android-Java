 ...
 */
public class setBuyerTo0 extends StringRequest {
    private static final String REGISTER_REQUEST_URL = "http://sfsuse.com/~kkwok/Files/setBuyerTo0.php";
    private Map<String, String> parameters;

    //Constructor to ask for name, username, age, password, listener
    public setBuyerTo0(String name, String license, double latitude, double longitude,
